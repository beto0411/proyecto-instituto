...
<section class="seccion contenedor">
  <h2>Registro de usuarios</h2>
    <form id="registro" class="registro" action="validar_registro.php" method="post">
        ...
        <div id="eventos" class="eventos contenedor clearfix">
                           ...
                           <div id="resumen" class="resumen"><!--.Extras-->
                             <h3>Pago y extras</h3>
                             <div class="caja clearfix">
                               <div class="extras">
                                 <div class="orden">
                                   <label for="camisa_evento">Material del curso $150 <small>(promoción 10% de descuento)</small></label>
                                   <input type="number" min="0" id="camisa_evento" size="3" placeholder="0" name="pedido_material" value="">
                                 </div>
                                 <div class="orden">
                                   <label for="etiquetas">Libro $100 <small>(html5, css3, JavaScript)</small></label>
                                   <input type="number" min="0" id="etiquetas" size="3" placeholder="0" name="pedido_libros" value="">
                                 </div>
